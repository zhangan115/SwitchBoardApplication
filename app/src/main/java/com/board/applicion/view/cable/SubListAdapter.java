...
import com.board.applicion.mode.cable.ControlRoomBean;
...
public class SubListAdapter extends BaseExpandableListAdapter {
    ...
    private List<SubstationBean> data = new ArrayList<>();

    private ItemClickListener listener;

    public interface ItemClickListener {

        void onItemClick(SubstationBean subBean,ControlRoomBean room);
    ...
    public void setData(List<SubstationBean> data) {
        this.data = data;
    }
    ...
    public int getChildrenCount(int groupPosition) {
        return data.get(groupPosition).getControlRoomList().size();
    }
    ...
    public Object getChild(int groupPosition, int childPosition) {
        return data.get(groupPosition).getControlRoomList().get(childPosition);
    }
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        holder.mName.setText(data.get(groupPosition).getSubstationName());
        if (isExpanded) {
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        ControlRoomBean room = data.get(groupPosition).getControlRoomList().get(childPosition);
        holder.mName.setText(room.getName());
        convertView.setOnClickListener(v -> {
            if (listener == null) {
                return;
            }
            listener.onItemClick(data.get(groupPosition),data.get(groupPosition).getControlRoomList().get(childPosition));
        });
        return convertView;
    }
